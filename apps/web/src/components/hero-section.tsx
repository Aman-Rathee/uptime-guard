    ...
    return (
        <section className="max-w-6xl mx-auto px-4 py-24 text-center">
            ...
            <div className="flex justify-center gap-2 max-w-md mx-auto">
                ...
                <Button size="lg" variant="secondary">Start Monitoring</Button>
            </div>
            ...
            <div className="max-w-6xl mx-auto px-4 py-24">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <Card className="bg-black/40 border-white/10">
                        <CardHeader>
                            <CardTitle className="text-white">1-Minute Checks</CardTitle>
                        </CardHeader>
                        <CardContent className="text-gray-400">
            ...
            <div className="py-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="bg-linear-to-br from-indigo-500/20 to-blue-500/20 rounded-2xl border border-indigo-500/30 p-12">
                        <h2 className="text-4xl md:text-5xl font-bold mb-4">Start Monitoring Today</h2>
                        <p className="text-xl text-gray-300 mb-8">Join thousands of companies keeping their services online</p>
